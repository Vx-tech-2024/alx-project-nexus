...
export const PollVotingPage: React.FC<PollVotingPageProps> = ({ pollId, onNavigate }) => {
    ...
    const [voteSubmitted, setVotedSumitted] = useState(false);
    ...
    const handleVote = async () => {
        if (!user) {
            toast.error('Authentication required', {
                description: 'Please log in to vote for the poll.',
        ...
        if (!selectedOption) {
            toast.error('No option selected', {
                description: 'Please select an option before clicking vote.',
        ...
        try {
            ...
            setVotedSumitted(true);
            toast.success('Vote Submitted', {
                description: 'Thank you for casting yor vote. View results below.',
                icon: <CheckCircle2 className="w-4 h-4" />
            });

            //NAvigating to results after a short delay
            setTimeout(() => {
            ...
            return (
                <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center p-4">
                    <Card className="p-8 text-center max-w-md">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Vote Recorder</h2>
                        <p className="text-gray-600 mb-6">
                            Your Vote has Successfully been submitted. View the Results to see how others voted.
                        </p>
                        <Button 
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm text-blue-900">
                                ...
                                <p className="text-blue-800">
                                    ...
                                    {poll.oneVotePerUser && 'You can only vote once per poll.'}
                                </p>
                            </div>
                        </div>
                    </Card>
